<script lang="js">
    ...
    let currentMagicType = ["Normal", "None", "None"]
    let writedMagicTypes = "Normal"

    function changeWritedMagicTypes() {
        writedMagicTypes = currentMagicType.filter(type => type !== "None").join(" / ");
        if (writedMagicTypes === "") {
            writedMagicTypes = "Normal";
        }
    }
...
<div class="card MagicCard" id="card">
	<!-- Fejléc -->
...
<div class="selectMagicTypes">
    <div class="row">
        <select bind:value={currentMagicType[0]}>
            {#each magicTypes["Simple"] as type}
                <option value="{type}"
                    on:click={() => {
                        changeWritedMagicTypes();
                    }}
                >{type}</option>
            {/each}
        </select>
    ...
    <div class="row">
        <select bind:value={currentMagicType[1]}>
    ...
    <div class="row">
        <select bind:value={currentMagicType[2]}>
